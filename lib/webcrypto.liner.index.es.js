        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (format) {
                ...
                case "spki":
                    ...
                    break;
                case "raw":
                    ecKey = this.importEcKey(new asn1.EcPublicKey(keyData), algorithm.namedCurve);
                    break;
                case "jwk":
...
export { Crypto, CryptoKey, crypto$1 as crypto, nativeCrypto, nativeSubtle, setCrypto };
